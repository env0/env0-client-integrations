...
const { API_KEY, API_SECRET, ORGANIZATION_ID, PROJECT_ID, TEMPLATE_ID, ENVIRONMENT_NAME } = options;

const INCLUDED_OPTIONS = [API_KEY, API_SECRET, ORGANIZATION_ID, PROJECT_ID, TEMPLATE_ID, ENVIRONMENT_NAME];
